...
def init_net(net, init_type='normal', init_gain=0.02, gpu_ids=[], parallel_mode='ddp'):
    ...
    if len(gpu_ids) > 0:
        ...
        if parallel_mode == 'ddp':
            net = DDP(net, device_ids=gpu_ids, output_device=gpu_ids[0], broadcast_buffers=False)
